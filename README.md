...
- **[GMAIL-DELIVERY-PROOF-CHECKLIST.md](templates/GMAIL-DELIVERY-PROOF-CHECKLIST.md)** — A deterministic canary + evidence workflow for “sent but recipient never got it” Gmail loops, covering sender proof, recipient-folder/routing checks, and escalation-ready packet fields
